...
if (!strlen($id_user)) {
	...
	$aColumns = array( 'IdEstacion', 'IdEstacion AS icons', 'EstacionServicio', 'NoEstacion', 'EsActivo');
	$aColumnsClean = array( 'IdEstacion', 'icons', 'EstacionServicio', 'NoEstacion', 'EsActivo');
